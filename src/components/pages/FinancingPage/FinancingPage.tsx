    ...
    content={
      <>
        <p>
          ...
          pariatur, doloribus perspiciatis similique aspernatur commodi, dolorem
          amet dolorum, vel, esse molestias minus exercitationem sit placeat ea
          dolores asperiores repellat corrupti!
        </p>
        ...
        <blockquote>
          ...
          accusantium optio aut omnis excepturi aspernatur fuga sequi quae vel,
          illo, ipsum sapiente, alias voluptate cupiditate reiciendis doloremque
          sint veritatis fugit.
        </blockquote>
        <p>
